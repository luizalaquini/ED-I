...
int main (void){
    ...
    InsereLista(lista1, sergio);
    InsereLista(lista1, raphael);
    InsereLista(lista1, luiza);
    ...
    InsereLista(lista2, sergioTrp);
    InsereLista(lista2, raphaelTrp);
    InsereLista(lista2, luizaTrp);
